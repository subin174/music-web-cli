...
public class PlaylistServiceIpml implements PlaylistService {
    ...
    public List<PlayList> sortView() {
        return playlistRepository.findTop10ByOrderByViewsDesc();
    }

    @Override
    public List<PlayList> sortLike() {
        return playlistRepository.findTop10ByOrderByLikesDesc();
    }

    @Override
    public List<PlayList> sortDate() {
        return playlistRepository.findTop3ByOrderByCreateDateDesc();
    }
